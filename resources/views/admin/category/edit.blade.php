                                ...
                                <div class="card-block">
                                    ...
                                    <form action="{{route('update.category',['id'=>$category->id])}}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <label for=""><input name="status" type="radio" value="1" {{$category->status == 1 ? 'checked':''}} > Published</label>
                                                <label for=""><input name="status" type="radio" value="0" {{$category->status == 0 ? 'checked':''}} > Unpublished</label>
                                            </div>
                                        </div>
