@include('admin.master_layout_admin.header')
...
{{--Upper Nav menu section start here--}}
                    ...
                    <ul class="nav-left">
                        <li class="header-search">
                            <div class="main-search morphsearch-search">
                                <div class="input-group"><span class="input-group-prepend search-close"><i class="feather icon-x input-group-text"></i></span>
...
{{--                                notifiction box section start here--}}
...
{{--                                notifiction box section end here--}}
...
{{--                        user dropdown section start here--}}
...
{{--                        user dropdown section end here--}}

                    </ul>
                </div>
            </div>
        </nav>
{{--Upper Nav menu section end here--}}

{{--        chatbox section start here--}}
...
{{--        chatbox section end here--}}

{{--        chatbox chat reading section start here--}}
...
{{--main navigation section start here--}}
                    ...
                    <div class="nav-list">
                        <div class="pcoded-inner-navbar main-menu">
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                ...
                                <li class="pcoded-hasmenu {{Request::route()->getName() == 'add.category' || Request::route()->getName() == 'manage.category' || Request::route()->getName() == 'edit.category' ? 'active pcoded-trigger':''}}">
                                    ...
                                    <ul class="pcoded-submenu">
                                        <li class="{{Request::route()->getName() == 'add.category' ? 'active':''}}">
                                            <a href="{{route('add.category')}}" class="waves-effect waves-dark">
                                                <span class="pcoded-mtext">Add Category</span>
                                            </a>
                                        </li>
                                        <li class="{{Request::route()->getName() == 'manage.category'|| Request::route()->getName() == 'edit.category' ? 'active':''}}">
                                            <a href="{{route('manage.category')}}" class="waves-effect waves-dark">
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                ...
                                {{--                            Blog Module section start here--}}
                                ...
                                {{--                            Blog Module section end here--}}

                                {{--                            Comment Module section start here--}}
                                ...
                                {{--                            Comment Module section end here--}}

                                {{--                            User Module section Start here--}}
                                <li class="pcoded-hasmenu">
                                    <a href="javascript:void(0)" class="waves-effect waves-dark">
                                        <span class="pcoded-micon">
...
{{--main navigation section end here--}}

    </div>
</div>


@include('admin.master_layout_admin.footer')
